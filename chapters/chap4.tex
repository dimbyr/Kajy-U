...
\begin{figure}[H]
	\centering
	% \includegraphics[width=0.5\textwidth]{stack_illustration.png}  % Exemple d'illustration d'une pile
...
\begin{figure}[H]
	\centering
	% \includegraphics[width=0.5\textwidth]{queue_illustration.png}  % Exemple d'illustration d'une file
...
\begin{figure}[H]
	\centering
	% \includegraphics[width=0.5\textwidth]{binary_tree_illustration.png}  % Exemple d'illustration d'un arbre binaire
	[FIGURE TO BE ADDED HERE]
...
\begin{figure}[H]
	\centering
	% \includegraphics[width=0.5\textwidth]{graph_illustration.png}  % Exemple d'illustration d'un graphe
